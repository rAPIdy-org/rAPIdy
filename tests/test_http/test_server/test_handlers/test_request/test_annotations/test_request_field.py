...
async def only_untyped_request_handler(request) -> None:  # type: ignore[no-untyped-def]
    pass


async def without_request_handler(username: Annotated[Any, Body()]) -> None:
    pass


async def with_request_fst_handler(request: web.Request, username: Annotated[Any, Body()]) -> None:
    pass


async def with_request_snd_handler(username: Annotated[Any, Body()], request: web.Request) -> None:
    pass


async def with_request_different_name_handler(any_req: web.Request, username: Annotated[Any, Body()]) -> None:
    pass
...
async def test_request_defined_twice(attr1_type: Any, attr2_type: Any) -> None:
    async def post(_: attr1_type, __: attr2_type) -> None:
        pass
