...
from rapidy.request_params import RapidParamType
...
class RapidParam:
    def __init__(
            self,
            rapid_param_type: RapidParamType,
            extractor: Any,
...
class RapidParamFieldInfo(FieldInfo, RapidParam, ABC):
    def __init__(
            self,
            rapid_param_type: RapidParamType,
            extractor: Any,
        ...
        RapidParam.__init__(
            self,
            rapid_param_type=rapid_param_type,
            extractor=extractor,
...
if PYDANTIC_V1:
    ...
    class ModelField(PydanticModelField):
        def __init__(
            ...
            rapid_param_type: Optional[RapidParamType] = kw.pop('rapid_param_type', None)
            if rapid_param_type:
                self.rapid_param_type = rapid_param_type
    ...
    def create_field(
        ...
        kwargs: Dict[str, Any] = {
            ...
            'field_info': field_info,
            'type_': type_,
            'rapid_param_type': field_info.rapid_param_type,
