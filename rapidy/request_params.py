...
from rapidy._request_params_base import RapidParamType, ValidateType
from rapidy.constants import MAX_BODY_SIZE
from rapidy.fields import create_field, get_annotation_from_field_info, ModelField, RapidParamFieldInfo
...
class PathBase(RapidParamFieldInfo):
    def __init__(self, **kwargs: Any):
        super().__init__(**kwargs, rapid_param_type=RapidParamType.path, extractor=extract_path, can_default=False)
...
class HeaderBase(RapidParamFieldInfo):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(**kwargs, rapid_param_type=RapidParamType.header, extractor=extract_headers)
...
class CookieBase(RapidParamFieldInfo):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(**kwargs, rapid_param_type=RapidParamType.cookie, extractor=extract_cookies)
...
class QueryBase(RapidParamFieldInfo):
    def __init__(self, **kwargs: Any) -> None:
        super().__init__(**kwargs, rapid_param_type=RapidParamType.query, extractor=extract_query)
...
class BodyBase(RapidParamFieldInfo, ABC):
    def __init__(
            self,
            media_type: str,
            *,
        ...
        super().__init__(
            **kwargs,
            extractor=extractor,
            rapid_param_type=RapidParamType.body,
        )
