...
from rapidy.request_params import RapidParamFieldInfo
...
def extract_handler_attr_annotations(
    ...
    if not isinstance(field_info, RapidParamFieldInfo):
        if isinstance(field_info, type) and issubclass(field_info, RapidParamFieldInfo):
