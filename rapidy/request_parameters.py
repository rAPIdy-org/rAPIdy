...
class Body(ParamFieldInfo):
    ...
    _base_annotation_body_type_map: Dict[Any, RequestBodyType] = {
        str: RequestBodyType.text,
        int: RequestBodyType.text,
        float: RequestBodyType.text,
        Decimal: RequestBodyType.text,
        bytes: RequestBodyType.binary,
        StreamReader: RequestBodyType.binary,
    }
    ...
    def __init__(
            ...
            *,
            ...
            validate: bool = True,
            body_type: Optional[RequestBodyType] = None,  # default: json
    ...
    @cached_property
    def body_type(self) -> RequestBodyType:
    ...
    def _create_default_body_type(self) -> RequestBodyType:
        assert self.annotation
